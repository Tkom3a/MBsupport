...
python3 -m shotcli set sl 0.22
python3 -m shotcli set sllong 0.22
python3 -m shotcli set slshort 0.30
python3 -m shotcli set slv2long 0.22
python3 -m shotcli set slv2short 0.22
```
