...
| Мин. дистанция ордера % | ордер с D ниже порога не ставится (по умолчанию 0.85) |
| Мин. зазор V2 % | страховочный не ближе этого % к первому; если среднее V2 меньше — ставим первый+зазор (0.3) |
