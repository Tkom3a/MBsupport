...
3. Ставит лимиты BUY и SHORT на дистанциях D% (стороны считаются отдельно) с запазданием **1 с**.
...
| Элемент | Назначение |
|---|---|
| Order size | номинал USDT уже с плечом |
| Плечо | для новых клонов |
| Авто-стоп $ | порог минуса |
| Применить | записать размер / плечо / авто-стоп |
